function GoogleLogo() {
  return (
    <svg viewBox="0 0 24 24" className="size-4.5" aria-hidden="true">
      ...
      <path
        fill="#EA4335"
        d="M12 4.75c1.76 0 3.35.61 4.6 1.8l3.44-3.44C17.95 1.19 15.24 0 12 0 7.31 0 3.25 2.7 1.27 6.6l4 3.11c.95-2.85 3.6-4.96 6.73-4.96z"
      />
    </svg>
  );
}
...
export function GoogleButton({ label = "Continue with Google" }: { label?: string }) {
  return (
    <a
      ...
      className="flex h-11 w-full items-center justify-center gap-2.5 rounded-lg border border-white/15 bg-white text-sm font-medium text-gray-700 transition-colors hover:bg-white/90"
    >
      <GoogleLogo />
      {label}
    </a>
